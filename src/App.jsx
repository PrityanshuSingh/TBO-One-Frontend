...
const PeronalizedPackages = lazy(
  () => import("./pages/Packages/PersonalizedPackages")
);

const WhatsAppCampaign = lazy(
  () => import("./pages/Campaign/WhatsAppCampaign")
);
const InstagramCampaign = lazy(
  () => import("./components/Modals/InstagramModal")
);
      ...
      <Suspense fallback={<Load />}>
        <Routes>
          ...
          <Route
            ...
            element={
              id ? (
                <Navigate to={`/u/packages/details/${id}`} replace />
              ) : cid || pid ? (
                <Navigate to={`/packages/details/${cid || pid}`} replace />
              ) : (
                <ErrorPage />
              )
            }
              ...
              <ProtectedRoute>
                ...
                <div className={styles.mainContent}>
                  <Routes>
                    ...
                    <Route
                      path="/u/packages/saved"
                      element={<SavedPackages />}
                    />
                    <Route
                      path="/u/packages/personalized"
                      element={<PeronalizedPackages />}
                    />

                    <Route
                      path="/u/packages/details/:id"
                      element={<PackageDetails />}
                    />

                    <Route
                      path="/u/packages/whatsAppCampaign/:id"
                      element={[<Packages />, <WhatsAppCampaign />]}
                    />
                    <Route
                      path="/u/packages/instagramCampaign/:id"
                      element={[<Packages />, <InstagramCampaign />]}
                    />
                    <Route
                      path="/u/packages/emailCampaign/:id"
                      element={[<Packages />, <EmailCampaign />]}
                    />

                    <Route
                      path="/u/packages/edit/:id"
                      element={<PackageDetails />}
                    />

                    <Route path="/u/campaigns" element={<Campaigns />} />
                    <Route
                      path="/u/campaigns/edit/:id"
                      element={[<Campaigns />, <WhatsAppCampaign />]}
                    />
